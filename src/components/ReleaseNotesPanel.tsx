...
const RELEASES: readonly Release[] = [
  {
    ...
    date: '2026-06-05',
    highlights: [
      '月のサマリーで、工数を設定した有償案件を上に、未設定の案件を下にまとめて表示するようにしました',
      'ブロック編集の作業時間を、スライダーのドラッグやマウスホイールで直感的に変更できるようにしました',
      'ブロックの通知を「1分前」「5分前」などのボタンから設定できるようにし、複数のタイミングを同時に指定できるようになりました',
      '設定 > 一般 で、新しく作成するブロックのデフォルト通知タイミングを設定できるようにしました',
    ],
  },
  {
    version: '0.5.1',
